...
namespace LondonBicycles.Client.Views
{
    ...
    /// </summary>
    public sealed partial class AllStationsPage : LondonBicycles.Client.Common.LayoutAwarePage
    {
        ...
        public void StationClicked(object sender, ItemClickEventArgs e)
        {
            ...
            AllStationsViewModel allStationsVm = this.DataContext as AllStationsViewModel;
            allStationsVm.NavigateToDetails(selectedStation);
        }
